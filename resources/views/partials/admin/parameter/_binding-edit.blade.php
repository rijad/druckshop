 ...
 <div class="form-group ">
     ...
     <table id="binding_table">
         ...
         <tr class="form-inline">
            ...
            <td><input class="form-control product_price" id="product_price" type="number" name="product_price[]" value="{{ $value_pp['price'] }}" required placeholder="price" step = "0.01" onchange="decimalplace(this);" onfocusout="decimalplace(this);" /></td>
        </tr>
