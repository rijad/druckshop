<div class="card mb-4 mt-4">
    <div class="card-header">
        ...
        @endif
    <form  class="form-group-inline" method="POST" action="{{ route('backcover.update' , $backcover->id) }}" 
        ...
        @csrf
            ...
            <div class="form-group">
                <div class="custom-control custom-checkbox small">
                    <input class="custom-control-input" type="checkbox" id="status" name="status" <?php echo ($backcover->status) ? 'checked' : ''; ?> >
                    <label class="custom-control-label" for="status">Active</label>
                </div>
            </div>
            <div class="form-inline">
                <a href="{{ url('/admin/details/BackCovers/5') }}" class="btn btn-secondary btn-user btn-block col-md-3">Back</a>
