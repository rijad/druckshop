                              ...
                              @foreach ($product_data as $data)
                                ...
                                <div class="product_listing">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                      <label for="pwd">Address data:</label>
                                      <input type="text" name="address_data" class="form-control" placeholder="enter here">
                                    </div>
                                      ...
                                      <div class="rv-manageAddressFields">
                                        ...
                                        <div class="rv-adressesfields">
                                         <div class="form-group">
                                            ...
                                            <textarea name="shipping_address" id="shipping_address" class="form-control" data-toggle="modal" data-target="#rv-Modal"></textarea>
...
<!-- Modal -->
<div class="modal fade rv-modalFormCustom" id="rv-Modal" role="dialog">
             ...
             <div class="cart-form-shop w-100">
               <form method = "POST" action="">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" > <option value ="-1">Select</option>
                      <option value="1399087"></option> 
                        </select>
                      </div>
                      <div class="form-group">
