				...
				<div id="heroSlider" class="carousel carousel-fade" data-ride="carousel">
					  <div class="carousel-inner">
					    ...
					    <div class="carousel-item active">
					      <img src="{{ asset('public/images/slide-01.png') }}" class="d-block w-100" alt="...">
					      <div class="carousel-caption text-left sliderCaption">
					      	<div class="container">
						        <h5>Product Slide Title 1</h5>
					    ...
					    <div class="carousel-item">
					      <img src="{{ asset('public/images/slide-02.png') }}" class="d-block w-100" alt="...">
					      <div class="carousel-caption text-left sliderCaption">
					      	<div class="container">
						        <h5>Product Slide Title 2</h5>
						        <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
						        <a href="#">Read More</a>
						    </div>
					      </div>
					    ...
					    <div class="carousel-item">
					      <img src="{{ asset('public/images/slide-03.png') }}" class="d-block w-100" alt="...">
					      <div class="carousel-caption text-left sliderCaption ">
					      	<div class="container">
						        <h5>Product Slide Title 3</h5>
						        <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
						        <a href="#">Read More</a>
						    </div>
					      </div>
					     ...
					     <div class="carousel-item">
					      <img src="{{ asset('public/images/slide-04.png') }}" class="d-block w-100" alt="...">
					      <div class="carousel-caption text-left sliderCaption ">
					      	<div class="container">
						        <h5>Product Slide Title 4</h5>
						        <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
						        <a href="#">Read More</a>
						    </div>
					      </div>
					...
					<div class="row">
						<div class="col-sm-6 col-md-4">
							<div class="product-block text-center">
								<a class="prodcutImage" href="">
									<img src="{{ asset('public/images/product-01.png') }}" alt="" />
								</a>
								<div class="proInfo">
									<h2>Thermal binding as an affordable classic option</h2>
									<p>The thermal binding is the classic choice for printing and binding a thesis. The reason for this binding being the best-selling cover for students is the attractive price and short production time.  </p>
									<a href="#">Read More</a>
								</div>
							</div>
						</div>
