...
// -------     Code to handle checkout page pagination Starts----------- //
	...
	function getValidatedFields(tab = ""){ //alert(tab);
		...
		if(tab == "1"){ 
			...
			$('#error_no_of_copies').html(lang_text.required); valid = false; return false;
...
function checkPageRange(id1 = '', id2 = '' ,value_id = ''){  
 ...
 if(range >= 0){  
    ...
    if(range < 0){
    	document.getElementById('colored_page_numbers').value = parseInt(0);
    }else{
